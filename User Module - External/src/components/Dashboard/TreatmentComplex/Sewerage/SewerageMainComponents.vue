  ...
  data() {
    return {
      components: {
        ...
        pumpingstation: 'no',
        outlets: 'no',
        pipelinesforcemain: 'no',
        pipelinesgravitysewer: 'no',
        manholes: 'no',
        other: 'no',
      },
      componentList: [
        { key: 'treatmentplant', label: 'Sewerage Treatment Plant' },
        { key: 'pumpingstation', label: 'Sewerage Pumping Station' },
        { key: 'outlets', label: 'Sewerage Outlets' },
        { key: 'pipelinesforcemain', label: 'Sewerage Pipe Lines - Force Main' },
        { key: 'pipelinesgravitysewer', label: 'Sewerage Pipe Lines - Gravity Sewer' },
        { key: 'manholes', label: 'Sewerage Manholes' },
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          Swal.fire({
            ...
            this.$router.push({ path: '/water-sewerage/components/chosen', query: { components: query } });
          });
        }
      });
    }
