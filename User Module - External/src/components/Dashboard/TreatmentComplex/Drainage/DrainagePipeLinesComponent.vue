<template>
  <div class="container mt-3">
    <form class="card shadow-sm p-4 drainage-pipelines-card" @submit.prevent="submitForm">

      <!-- Total Length of Drainage Pipe Lines (km) -->
      <div class="form-row">
        <label for="totalLength"><b>Total Length of Drainage Pipe Lines (km)</b><span class="text-danger">*</span></label>
      ...
      <div class="alert alert-info my-3">
        If the Cost of  the Drainage Pipe Lines unknown fill “0” in both fields.
      </div>

      <!-- Total Construction Cost of the Cost Known Drainage Pipe Lines (km) -->
      <div class="form-row same-line">
        <label class="section-label">
          <b>Total Construction Cost of the Cost Known Drainage Pipe Lines (km)</b><span class="text-danger">*</span>
        </label>
      ...
      <!-- Length of Cost Unknown Drainage Pipe Lines (km) -->
      <div class="form-row">
        <label for="lengthOfUnknownLines"><b>Length of Cost Unknown Drainage Pipe Lines (km)</b><span class="text-danger">*</span></label>
...
export default {
  ...
  methods: {
    ...
    calculateUnknownLength() {
      ...
      this.formData.lengthOfUnknownLines = (A - B >= 0 ? (A - B).toFixed(2) : 0);
    },
    submitForm() {
