<template>
  <div class="container mt-3">
    <form class="card shadow-sm p-4 drainage-pipelines-card" @submit.prevent="submitForm">
      ...
      <div class="form-row">
        <label for="totalLength"><b>Total Length of Drainage Pipe Lines (km)</b></label>
      ...
      <div class="form-row same-line">
        <label class="section-label">
          <b>Total Construction Cost of the Cost Known Drainage Pipe Lines (km)</b>
        </label>
      ...
      <div class="form-row">
        <label for="lengthOfUnknownLines"><b>Length of Cost Unknown Drainage Pipe Lines (km)</b></label>
