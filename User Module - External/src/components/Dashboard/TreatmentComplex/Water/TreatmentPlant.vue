<template>
  <div class="container mt-3">
    <form class="card shadow-sm p-4 treatment-plant-card" @submit.prevent="submitForm">
      ...
      <div class="location-section">
        ...
        <div class="inline-fields">
          <select v-model="formData.treatmentPlant.unit" @change="convertToKm2" class="form-select" required>
          ...
          <input
            ...
            type="text"
            v-model="formData.treatmentPlant.landOwner"
            class="form-control"
  ...
  data() {
    return {
      formData: {
        ...
        capacityM3: '',
        treatmentPlant: { unit: '', area: '', areaKm: '', landOwnership: '', landOwner: '' },
        ownership: '',
        fromWhom: '', 
        toWhom: '',
        periodFrom: '', 
