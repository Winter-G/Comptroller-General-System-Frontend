<template>
  <div class="container mt-3">
    <form class="card shadow-sm p-4 water-chlorinators-card" @submit.prevent="submitForm">
      ...
      <div class="form-row">
        <label for="minCapacity"><b>Minimum Capacity (kg/h)</b></label>
        <input id="minCapacity" class="form-control" type="text"
               v-model="formData.minCapacity" @input="validateDecimal($event, 'minCapacity')" />
      </div>

      <!-- Maximum Capacity (kg/h) -->
      <div class="form-row">
        <label for="maxCapacity"><b>Maximum Capacity (kg/h)</b></label>
        <input id="maxCapacity" class="form-control" type="text"
               v-model="formData.maxCapacity" @input="validateDecimal($event, 'maxCapacity')" />
      </div>
