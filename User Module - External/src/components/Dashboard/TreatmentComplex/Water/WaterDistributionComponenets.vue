  ...
  data() {
    return {
      components: {
        ...
        watervalve: 'no',
        waterpumphouse: 'no',
        waterchlorinators: 'no',
        other: 'no',
      },
      componentList: [
        { key: 'watertower', label: 'Water Tower' },
        { key: 'watertank', label: 'Water Tank (Above Ground/<br>Under Ground)' },
        { key: 'watervalve', label: 'Water Valve' },
        { key: 'waterpumphouse', label: 'Water Pump House' },
        { key: 'waterchlorinators', label: 'Water Chlorinators' },
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          Swal.fire({
            ...
            this.$router.push({ path: '/water-distribution/components/chosen', query: { components: query } });
          });
        }
      });
    }
