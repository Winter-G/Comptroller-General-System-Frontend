<template>
  <div class="main-container">
    ...
    <div class="instructions">
      ...
      <p>
        If you have more than one item in a component (e.g., 2 Water Towers), fill in all info for the first item and click <strong>SAVE</strong>. Then click <strong>Add Next</strong> and select the same component again to add the second one.
      </p>
    </div>
...
export default {
  data() {
    return {
      componentMap: {
        ...
        watertank: 'Water Tank (Above Ground/Under Ground)',
        watervalve: 'Water Valve',
        waterpumphouse: 'Water Pump House',
        waterchlorinators: 'Water Chlorinators',
        other: 'Other'
      },
      components: [],
      selectedComponent: ''
  ...
  methods: {
    ...
    goToComponentPage() {
      const routeMap = {
        watertower: 'WaterTowerComponent',
        watertank: 'WaterTankComponent',
