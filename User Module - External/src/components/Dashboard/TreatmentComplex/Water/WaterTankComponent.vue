<template>
  <div class="container mt-3">
    <form class="card shadow-sm p-4 water-tank-card" @submit.prevent="submitForm">
      ...
      <!-- Type of Tank -->
      <div class="form-row">
        <label><b>Type of Tank</b><span class="text-danger">*</span></label>
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      const requiredFields = ["identificationName", "type", "capacityM3"];
