...
import ChosenInComplexComponents from "./ChosenInComplexComponents.vue";
  ...
  data() {
    return {
      components: {
        ...
        joggingPath: 'no',
        linearPath: 'no',
        gymnasiumStrengthHallFitnessHall: 'no',
        park: 'no',
        other: 'no'
      },
      componentList: [
        { key: 'indoorStadium', label: 'Indoor Stadium' },
        { key: 'outdoorStadium', label: 'Outdoor Stadium' },
        { key: 'playground', label: 'Play Ground' },
        { key: 'swimmingPool', label: 'Swimming Pool' },
        { key: 'joggingPath', label: 'Jogging Path' },
        { key: 'linearPath', label: 'Linear Path' },
        { key: 'gymnasiumStrengthHallFitnessHall', label: 'Gymnasium/Strength Hall/<br>Fitness Hall' },
        { key: 'park', label: 'Park' },
