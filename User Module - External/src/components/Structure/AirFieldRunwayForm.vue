  ...
  try {
    ...
    const response = await axios.get(
      "/management/get/api/production/system/management/backend/restapi/get/all/contdistrict",
      {
        headers: {
          Authorization:
            "Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJpc3VydSIsImlhdCI6MTc1NDUzNzkyMywiZXhwIjoxNzU0NjI0MzIzfQ.e8-PZHdtD95gL9x5pWEX3RDgVKziB11o3FU4isFI-HpFlZ2nv8c8gommiZYtcQiCI8CZv47aPic7fBw_sBQG7Q",
...
const saveNewName = async () => {
  ...
  try {
    ...
    // Get auth headers with the specific token (fixed the typo)
    const headers = {
      Authorization:
        "Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJpc3VydSIsImlhdCI6MTc1NDUzNzkyMywiZXhwIjoxNzU0NjI0MzIzfQ.e8-PZHdtD95gL9x5pWEX3RDgVKziB11o3FU4isFI-HpFlZ2nv8c8gommiZYtcQiCI8CZv47aPic7fBw_sBQG7Q",
      "Content-Type": "application/json",
